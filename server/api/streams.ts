...
export default defineEventHandler(async () => {
  ...
  const filteredStreams = filterStreams(streams, [['vue'], ['nuxt'], ['vue.js'], ['nuxt.js']])
...
async function fetchStream({id, clientId, accessToken, cursor}: FetchStreamParams) {
...
async function getAccessToken({clientId, clientSecret}: GetAccessTokenParams): Promise<string> {
